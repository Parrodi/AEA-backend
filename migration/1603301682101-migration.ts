...
export class migration1603301682101 implements MigrationInterface {
    name = 'migration1603301682101'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "hearing" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" "hearing_name_enum" NOT NULL DEFAULT 'Audiencia de Conciliación demanda y excepciones', "date" TIMESTAMP NOT NULL, "time" TIME NOT NULL, "lawyerId" uuid, CONSTRAINT "PK_9a5ad1f15d540f0d70860aba349" PRIMARY KEY ("id"))`);
